    ...
    return (
        <Fragment>
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="width" className="form-label mr-2">Width</label>}
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="height" className="form-label mr-2">Height</label>}
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="borderRadius" className="form-label mr-2">Border radius</label>}
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="borderWidth" className="form-label mr-2">Border width</label>}
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="borderColor" className="form-label mr-2">Border color</label>}
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="background" className="form-label mr-2">Background color</label>}
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="text" className="form-label mr-2">Text</label>}
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="fontSize" className="form-label mr-2">Size</label>}
            ...
            <div className="settingBarItem">
                {window.innerWidth > 750 && <label htmlFor="fontColor" className="form-label mr-2">Line colour</label>}
